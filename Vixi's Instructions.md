...
JOBS=1 UBUNTU_SNAPSHOT= bin/build-docker-image ghcr.io/snowsune/danbooru
...
If apt fails on snapshot.ubuntu.com, `UBUNTU_SNAPSHOT=` (empty) skips the snapshot mirror.
